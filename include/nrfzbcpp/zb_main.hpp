...
namespace zb
{
    ...
    //given multiples of attribute_list_t<> objects this constructs and returns a cluster_list_t<..>
    ...
    constexpr auto to_clusters(ClusterAttributesDesc&... c) -> cluster_list_t<ep, ClusterAttributesDesc...> { return {c...}; }

    //given multiples clusters in form of cluster_list_t<> this constructs and returns a ep_desc_t<..>
    ...
    constexpr auto configure_ep(cluster_list_t<i.ep, T...> &clusters) -> ep_desc_t<i, cluster_list_t<i.ep, T...>>
    {
        return {clusters};
    }
    ...
    constexpr auto configure_device(ep_desc_t<i, Clusters>&...eps) { return device_t{eps...}; }

    template<class... SelfContainedEP> requires (is_ep_desc_self_contained_c<SelfContainedEP> && ...)
    constexpr auto configure_device(SelfContainedEP&...eps) { return device_t{eps.ep...}; }
