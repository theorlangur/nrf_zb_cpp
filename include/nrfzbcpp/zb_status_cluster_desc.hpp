...
namespace zb
{
    ...
    static constexpr uint16_t kZB_ZCL_CLUSTER_ID_STATUS2 = 0xfc81;
    struct zb_zcl_status2_t
    {
        static constexpr uint8_t kCMD1 = 1;
        static constexpr uint8_t kCMD2 = 2;
        static constexpr uint8_t kCMD3 = 3;
    ...
    template<> struct zcl_description_t<zb_zcl_status2_t> {
        static constexpr auto get()
        {
            using T = zb_zcl_status2_t;
            return cluster_t<
                cluster_info_t{.id = kZB_ZCL_CLUSTER_ID_STATUS2},
                attributes_t<
                    attribute_t{.m = &T::status1,.id = 0x0000, .a=access_t::RP},
                    attribute_t{.m = &T::status2,.id = 0x0001, .a=access_t::RP},
                    attribute_t{.m = &T::status3,.id = 0x0002, .a=access_t::RP},
                    attribute_t{.m = &T::status4,.id = 0x0003, .a=access_t::RP}
                >{},
                commands_t<&T::cmd1, &T::cmd2, &T::cmd3>{}
            >{};
        }
